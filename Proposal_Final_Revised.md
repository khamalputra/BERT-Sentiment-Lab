...
1. ***McNemar’s Test***
 Digunakan pada level prediksi sampel individu pada *Held-out Test Set* (872 sampel) untuk menguji apakah perbedaan proporsi kesalahan klasifikasi bersifat simetris atau asimetris (McNemar, 1947; Dror et al., 2018). Matriks kontingensi $2 \times 2$ dibangun secara khusus dari pasangan prediksi sampel pada *seed* acuan utama (*Seed 42*), yang dipilih secara transparan sebagai *seed* pertama yang terdaftar dalam rancangan eksperimen *multi-seed* sekaligus merepresentasikan *checkpoint* performa optimum utama pada Model B yang di-*deploy* ke aplikasi web. Uji ini menghasilkan statistik $\chi^2$ dan nilai $p$-value.
2. ***Wilcoxon Signed-Rank Test***
