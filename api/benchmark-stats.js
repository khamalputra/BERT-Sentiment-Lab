// Vercel Serverless Function: Benchmark Stats Proxy
export default async function handler(req, res) {
  ...
  const GPU_URL = 'https://irritably-tipper-january.ngrok-free.dev/api/benchmark-stats';
  const RAILWAY_URL = 'https://nurturing-creation-production-4414.up.railway.app/api/benchmark-stats';
